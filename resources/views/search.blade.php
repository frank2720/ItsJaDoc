								...
								<div class="doc-info-left">
									...
									<div class="doc-info-cont">
										...
										<div class="clinic-details">
											<p class="doc-location"><i class="fas fa-map-marker-alt"></i> Nairobi, Kenya</p>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="far fa-money-bill-alt"></i> Ksh. 300 - Ksh. 1000 <i class="fas fa-info-circle" data-toggle="tooltip" title="Lorem Ipsum"></i> </li>
										</ul>
									</div>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="fas fa-map-marker-alt"></i> Nairobi, Kenya</li>
											<li><i class="far fa-money-bill-alt"></i> Ksh. 50 - Ksh. 300 <i class="fas fa-info-circle" data-toggle="tooltip" title="Lorem Ipsum"></i></li>
										</ul>
									</div>
									<div class="clinic-booking">
										<a class="view-pro-btn" href="doctor-profile.html">View Profile</a>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="far fa-comment"></i> 35 Feedback</li>
											<li><i class="fas fa-map-marker-alt"></i> Nairobi, Kenya</li>
											<li><i class="far fa-money-bill-alt"></i> Ksh. 100 - Ksh. 400 <i class="fas fa-info-circle" data-toggle="tooltip" title="Lorem Ipsum"></i></li>
										</ul>
									</div>
									<div class="clinic-booking">
										<a class="view-pro-btn" href="doctor-profile.html">View Profile</a>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="fas fa-map-marker-alt"></i> Nairobi, Kenya</li>
											<li><i class="far fa-money-bill-alt"></i> Ksh. 150 - Ksh. 250 <i class="fas fa-info-circle" data-toggle="tooltip" title="Lorem Ipsum"></i></li>
										</ul>
									</div>
									<div class="clinic-booking">
										<a class="view-pro-btn" href="doctor-profile.html">View Profile</a>
								...
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="fas fa-map-marker-alt"></i> Nairobi, Kenya</li>
											<li><i class="far fa-money-bill-alt"></i> Ksh. 100 - Ksh. 500 <i class="fas fa-info-circle" data-toggle="tooltip" title="Lorem Ipsum"></i></li>
										</ul>
									</div>
									<div class="clinic-booking">
										<a class="view-pro-btn" href="doctor-profile.html">View Profile</a>
