...
<head>
        ...
        <title>ItsJaDoc- Dashboard</title>
										...
										<table class="table table-hover table-center mb-0">
											...
											<tbody>
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/doctors/doctor-thumb-01.jpg" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/doctors/doctor-thumb-02.jpg" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/doctors/doctor-thumb-03.jpg" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/doctors/doctor-thumb-04.jpg" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/doctors/doctor-thumb-05.jpg" alt="User Image"></a>
										...
										<table class="table table-hover table-center mb-0">
											...
											<tbody>
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/patients/patient1.jpg" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/patients/patient2.jpg" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/patients/patient3.jpg" alt="User Image"></a>
															<a href="">Carl Kelly</a>
														</h2>
													</td>
													<td>2607247769</td>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/patients/patient4.jpg" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="admin/assets/img/patients/patient5.jpg" alt="User Image"></a>
															<a href="">Gina Moore</a>
														</h2>
													</td>
													<td>9548207887</td>
