        ...
        <section class="section section-specialities">
            <div class="container-fluid">
                <div class="section-header text-center">
                    ...
                    <p class="sub-title">It is important to take care of the patient, to be followed by the client, but at the same time they will be affected by some great pains and sufferings.</p>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="section-header ">
                            ...
                            <p>Something about the doctors </p>
                        </div>
                            ...
                            <div class="profile-widget">
                                ...
                                <div class="pro-content">
                                    ...
                                    <ul class="available-info">
                                        ...
                                        <li>
                                            <i class="far fa-money-bill-alt"></i>Ksh. 300 -Ksh. 1000 
                            ...
                            <div class="profile-widget">
                                ...
                                <div class="pro-content">
                                    ...
                                    <ul class="available-info">
                                        ...
                                        <li>
                                            <i class="far fa-money-bill-alt"></i>Ksh. 50 -Ksh. 300 
                                            <i class="fas fa-info-circle" data-toggle="tooltip" title="Lorem Ipsum"></i>
                                        </li>
                                    </ul>
                                    <div class="row row-sm">
                            ...
                            <div class="profile-widget">
                                ...
                                <div class="pro-content">
                                    ...
                                    <ul class="available-info">
                                        ...
                                        <li>
                                            <i class="far fa-money-bill-alt"></i>Ksh. 150 -Ksh. 250 
                                            <i class="fas fa-info-circle" data-toggle="tooltip" title="Lorem Ipsum"></i>
                                        </li>
                                    </ul>
                                    <div class="row row-sm">
